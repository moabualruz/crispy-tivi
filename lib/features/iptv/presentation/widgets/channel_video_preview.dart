...
/// Transparent placeholder in the channel list TV layout
/// that marks where the video preview should appear.
///
...
///
/// Mirrors [EpgVideoPreview] but uses [AppRoutes.tv] as
/// the host route.
class ChannelVideoPreview extends ConsumerStatefulWidget {
  const ChannelVideoPreview({this.onTap, super.key});

  /// Called when the user taps to expand to fullscreen.
  final VoidCallback? onTap;

  @override
  ConsumerState<ChannelVideoPreview> createState() =>
      _ChannelVideoPreviewState();
}

class _ChannelVideoPreviewState extends ConsumerState<ChannelVideoPreview> {
