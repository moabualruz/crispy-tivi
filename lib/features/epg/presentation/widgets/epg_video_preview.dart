...
/// Transparent placeholder in the EPG layout that marks where
/// the video preview should appear.
///
...
class EpgVideoPreview extends ConsumerStatefulWidget {
  const EpgVideoPreview({this.onTap, super.key});

  /// Called when the user taps to expand to fullscreen.
  final VoidCallback? onTap;

  @override
  ConsumerState<EpgVideoPreview> createState() => _EpgVideoPreviewState();
}

class _EpgVideoPreviewState extends ConsumerState<EpgVideoPreview> {
