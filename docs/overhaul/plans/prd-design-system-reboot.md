...
3. Maintain requirements and execution plan under `docs/overhaul/plans/`.
...
- `docs/overhaul/plans/design-system-reboot-requirements.md` exists and includes every
  user requirement.
- `docs/overhaul/plans/design-system-reboot-execution-plan.md` exists and sequences work.
