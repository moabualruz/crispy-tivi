...
class MockShellContract {
  const MockShellContract({
  ...
  factory MockShellContract.fromJsonString(String source) {
    final Object? decoded = jsonDecode(source);
    if (decoded is! Map<String, dynamic>) {
      throw const FormatException('mock shell contract must be a JSON object');
    }
    return MockShellContract.fromJson(decoded);
  }

  factory MockShellContract.fromJson(Map<String, dynamic> json) {
    return MockShellContract(
...
class MockShellContractSupport {
  const MockShellContractSupport._({
    required this.startupRoute,
    required this.topLevelRoutes,
  ...
  factory MockShellContractSupport.fromContract(MockShellContract contract) {
    ...
    if (topLevelRoutes.contains(ShellRoute.settings)) {
      ...
      return MockShellContractSupport._(
