      ...
      child: Row(
        children: [
          _FilterChip(
            ...
            semanticLabel: context.l10n.searchFilterChannels,
          ),
          ...
          _FilterChip(
            ...
            semanticLabel: context.l10n.searchFilterMovies,
          ),
          const SizedBox(width: CrispySpacing.sm),
          _FilterChip(
            ...
            semanticLabel: context.l10n.searchFilterSeries,
          ),
          const SizedBox(width: CrispySpacing.sm),
          _FilterChip(
            label: context.l10n.searchFilterPrograms,
            icon: Icons.schedule,
            isSelected: filter.contentTypes.contains(SearchContentType.epg),
            selectedColor: colorScheme.primary,
            onTap: () => onToggle(SearchContentType.epg),
            semanticLabel: context.l10n.searchFilterPrograms,
          ),
        ],
      ),
    );
