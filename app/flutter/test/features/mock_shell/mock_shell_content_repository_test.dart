...
''';
    ...
    final MockShellContentSnapshot content =
        MockShellContentSnapshot.fromJsonString(source);
...
''');
    ...
    const MockShellContentRepository repository = MockShellContentRepository();
    final MockShellContentSnapshot content = await repository.load();
